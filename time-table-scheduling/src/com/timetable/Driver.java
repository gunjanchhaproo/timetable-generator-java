...
public class Driver {
	public static final int POPULATION_SIZE = 9;//ability to search jitni jada population size utna jada possibility ki accurtae timetable aayega
	public static final double MUTATION_RATE = 0.1;//chromosomes ke liye use hoga generation change krne ke liye
	public static final double CROSSOVER_RATE = 0.9;
	public static final int TOURNAMENT_SELECTION_SIZE = 3;//konsa fit hai woh select krega
